    ...
    T::Bound: Clone + Contains<T::Bound> + Union<T::Bound, Output = T::Bound> + SurfaceArea,
{
    ...
    fn rotate(&mut self, node_index: usize) -> Option<usize> {
        let improvement_percentage = SURFACE_AREA_IMPROVEMENT_FOR_ROTATION;
        ...
        if !left_is_leaf || !right_is_leaf {
            ...
            // only do actual rotation if the surface area is reduced by atleast 30%
